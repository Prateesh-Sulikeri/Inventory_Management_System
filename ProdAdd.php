...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `products`(`name`, `type`, `stock_available`, `price`, `image`) 
    VALUES ('$name','$type','$stock','$price', '$image')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid my-4">
                    ...
                    <section class="box">
                        <header class="mb-3 font-weight-bold">Add Product Details</header>
                        <hr>
