        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 my-4">Product's Information</h1>
                    <p>All the Products available in the Inventory are displayed here</p>
                    <p>You Can View, Add, Edit or Delete Product Information Here</p>
                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <button class="btn btn-primary mb-4"><a class="text-white text-decoration-none"
                                            href="prodAdd.php">ADD PRODUCT</a></button>
                                </div>
                            </div>
                                            ...
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <a class="btn btn-sm btn-info"
                                                        href="updateProd.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a
                                                        class="btn btn-sm btn-danger"
                                                        href="deleteProd.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
                                                <?php
                                            }
