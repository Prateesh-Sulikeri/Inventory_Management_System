        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 my-4">Orders Information</h1>
                    <p>All the live Orders in the system are displayed here</p>
                    <p>You Can View order Information Here</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Order Information Table</h6>
                        </div>
                        <div class="card-body">
                                        ...
                                        if ($result->num_rows > 0) {
                                            while ($row = $result->fetch_assoc()) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td><?php echo $row['price_per_piece'] * $row['quantity']; ?></td>
