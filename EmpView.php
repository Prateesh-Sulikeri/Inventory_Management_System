        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800 my-4">Employee Information</h1>
                    <p>All the Employee's Information available in the database is displayed here</p>
                    <p>You Can View, Add, Edit or Delete Employee Information Here</p>

                    <!-- DataTales Example -->
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Customer Information Table</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-sm-12 col-md-3">
                                    <button class="btn btn-primary mb-4"><a class="text-white text-decoration-none"
                                            href="EmpAdd.php">ADD EMPLOYEE</a></button>
                                </div>
                            </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <a class="btn btn-sm btn-info"
                                                            href="updateEmp.php?id=<?php echo $row['id']; ?>">Edit</a>&nbsp;<a
                                                            class="btn btn-sm btn-danger"
                                                            href="deleteEmp.php?id=<?php echo $row['id']; ?>">Delete</a>
                                                    </td>
                                                </tr>
