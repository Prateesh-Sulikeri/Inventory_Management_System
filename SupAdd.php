...
if (isset($_POST['submit'])) {
    ...
    $sql = "INSERT INTO `suppliers`(`sup_name`, `prod_name`, `type`, `price`,`email`,`quantity`) 
    VALUES ('$Sup_name','$Prod_name','$Prod_Type', '$price' ,'$email' ,'$quantity')";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid my-4">
                    ...
                    <section class="box">
                        <header class="mb-3 font-weight-bold">Add Supplier Details</header>
                        <hr>
                        <form action="#" class="form" method="POST">
                            <div class="column">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" name="Sup-name" placeholder="Enter Supplier Name" required />
                                </div>
                            </div>
                            ...
                            <div class="column">
                                ...
                                <div class="input-box">
                                    ...
                                    <input type="text" name="Prod-name" placeholder="Enter Product Name" required />
                                </div>

                                <div class="input-box">
                                    <label>Product Type</label>
                                    <input type="text" name="Prod-Type" placeholder="Enter Product Type" required />
                                </div>
