...
include_once "config.php";
    ...
    if(isset($_POST['submit'])) {
        ...
        $query = "UPDATE products SET name='$name', type='$type', stock_available ='$stock', price='$price', image='$image' WHERE id='$id'";
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid my-4">
                    ...
                    <section class="box">
                        <header class="mb-3 font-weight-bold">Edit Product Details</header>
                        <hr>
                        <form action="#" class="form" method="POST">
                            ...
                            <div class="column">
                                ...
                                <div class="input-box">
                                    <label>Quantity of Stock Available</label>
                                ...
                                <div class="input-box">
                                    <label>Image</label>
                                    <input type="text" name="image" placeholder="Enter image location" required />
                                </div>
                            </div>
